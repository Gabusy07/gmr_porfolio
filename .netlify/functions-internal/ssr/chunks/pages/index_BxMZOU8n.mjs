/* empty css                          */
import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderSlot, g as renderComponent } from '../astro_CpY2pXq3.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
/* empty css                          */
import { $ as $$Layout } from './404_RkDBWBx1.mjs';
...
const work = [
	...
	},
	{
		...
		urls: [
			"https://techforb.com/en",
			"https://www.avla.com/cl/corp"
		],
...
const $$SectionContainer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section${addAttribute(id, "id")}${addAttribute(`p-5 border border-gray-300 rounded-xl ${className}`, "class")} data-astro-cid-tdne747l> <div class="container m-2 flex justify-between" data-astro-cid-tdne747l> <h2 class="text-xl font-bold mb-5 opacity-60" data-astro-cid-tdne747l> ${title} </h2> ${icon ? renderTemplate`<img class="w-[1.5rem] h-[1.5rem]"${addAttribute(icon, "src")} data-astro-cid-tdne747l>` : null} </div> <div class="ml-2" data-astro-cid-tdne747l> ${renderSlot($$result, $$slots["default"])} </div> </section> `;
...
const $$Experience = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<ul data-astro-cid-xpq65ryk> ${EXPERIENCE.map((exp) => {
    ...
    return renderTemplate`<li class="mb-12" data-astro-cid-xpq65ryk> <article data-astro-cid-xpq65ryk> <header class="flex text-lg justify-between items-start mb-3 font-bold text-gray-500" data-astro-cid-xpq65ryk> <div data-astro-cid-xpq65ryk> <h1 class="h1" data-astro-cid-xpq65ryk>${exp.position}</h1> <h2 class="h2" data-astro-cid-xpq65ryk>${exp.name}</h2> </div> <time class="text-base font-bold text-gray-400" data-astro-cid-xpq65ryk> ${startDate} - ${exp.endDate ? endDate : "actualidad"} </time> </header> <footer class="text-base text-black-700" data-astro-cid-xpq65ryk> <summary class="mb-2" data-astro-cid-xpq65ryk>${exp.summary}</summary> ${exp.urls.map((url, index) => {
      return renderTemplate`<small data-astro-cid-xpq65ryk>
Go to
<a class="text-blue-500 font-semibold mr-4"${addAttribute(url, "href")} target="_blank" data-astro-cid-xpq65ryk> ${exp.name.toLowerCase() === "techforb - avla" ? avlaWorkCase[index] : exp.name} </a> </small>`;
...
const $$Hero = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Hero;
  const { name, label, location, image } = basics;
  const { country, region } = location;
  return renderTemplate`${maybeRenderHead()}<div class="flex flex-col gap-[50px] lg:flex-row items-center" data-astro-cid-bbe6dxrz> <div class="lg:mr-auto mb-4 lg:mb-0 lg:pr-4" data-astro-cid-bbe6dxrz> <h1 class="text-2xl lg:text-3xl font-bold mb-2" data-astro-cid-bbe6dxrz>${name}</h1> <h2 class="text-lg lg:text-xl font-semibold mb-2" data-astro-cid-bbe6dxrz>${label}</h2> <span class="text-xs lg:text-base" data-astro-cid-bbe6dxrz>${region}, ${country}</span> </div> <figure data-astro-cid-bbe6dxrz> <img class="img max-w-[130px] rounded-md"${addAttribute(image, "src")}${addAttribute(name, "alt")} data-astro-cid-bbe6dxrz> </figure> </div> `;
...
const $$Education = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="font-normal text-pretty"> ${education.map((edu) => {
    return renderTemplate`<article> <h2 class="text-lg mb-3"> ${` ${edu.studyType} in ${edu.area}`}</h2> <h4 class="text-base ">${`at ${edu.institution}`}</h4> </article>`;
  })} </div>`;
...
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="text-base font-normal text-pretty"> <p>${summary}</p> </div>`;
...
const $$Projects = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<ul data-astro-cid-amng4zvp> ${projects.map((project) => {
    return renderTemplate`<article class="p-3 m-1" data-astro-cid-amng4zvp> <header class="mb-3" data-astro-cid-amng4zvp> <a class="text-base text-green-700 font-semibold hover:text-lg hover:underline" title="See repository"${addAttribute(project.url, "href")} target="_blank" data-astro-cid-amng4zvp> <h3 class="inline text-lg" data-astro-cid-amng4zvp>${project.name}</h3> </a> ${project.isActive && renderTemplate`<span class="ml-3 text-blue-600 text-xs font-semibold" data-astro-cid-amng4zvp>
&bull; In progress
</span>`} </header> <div class="mb-3 text-thin" data-astro-cid-amng4zvp> <figure class="mb-5" data-astro-cid-amng4zvp> <a${addAttribute(project.url, "href")} target="_blank inline-link" data-astro-cid-amng4zvp> <img class="img w-[40%] min-w-[200px] rounded-md"${addAttribute(project.picture, "src")} alt="" data-astro-cid-amng4zvp> </a> </figure> <p class="font-thin opacity-75" data-astro-cid-amng4zvp>${project.description}</p> </div> <footer data-astro-cid-amng4zvp> <ul class="flex flex-wrap gap-3 mt-5" data-astro-cid-amng4zvp> ${project.highlights.map((highlight) => {
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "porfolio - web software developer fullstack", ".": true, "description": "fullstack developer junior", "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="p-4 md:p-6 lg:p-8 xl:p-10" data-astro-cid-j7pv25f6> <!-- <SectionContainer id="introduction", title="Bienvenido">
      <div class="text-center">
        <h1 class="text-xl mb-3">
          Soy Gabriel Remes, desarrollador <span class="text-red-600 font-bold"
            >fullstack</span
          >
        </h1>
        <p class="text-base mb-5">
          mayormente enfocado al desarrollo del backend
        </p>
        <p class="text-sm opacity-70 text-pretty">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores
          facere corporis inventore distinctio amet eligendi quidem sit aliquid,
          id sapiente animi a numquam quos magnam voluptatum tempora,
          consectetur iste sequi.
        </p>
      </div>
    </SectionContainer>

    <SectionContainer id="experience" title="Experiencia">
       <Experience />
    </SectionContainer>
    ...
    <SectionContainer id="projects", title="Proyectos">
      ...
      >
        <Card
          href="lumini"
          title="Lumini"
          body="Proyecto grupal de  red social"
          backgroundColor="bg-gradient-to-r from-green-600 via-green-500 to-green-500"
          imgRef="../public/noCountry-logo.png"
          owner="noCountry"
        />
        <Card
          href="tripmate"
          title="TripMate"
          body="Proyecto grupal de comunidad de viaje "
          backgroundColor="bg-gradient-to-r from-yellow-500 via-yellow-500 to-yellow-400"
          imgRef="../public/tripmate-logo.png"
          owner="noCountry"
        />
      </ul>
    </SectionContainer> --> ${renderComponent($$result2, "SectionContainer", $$SectionContainer, { "id": "hero", "title": "", "data-astro-cid-j7pv25f6": true }, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "Hero", $$Hero, { "data-astro-cid-j7pv25f6": true })}` })} ${renderComponent($$result2, "SectionContainer", $$SectionContainer, { "id": "about", "title": "About me", "data-astro-cid-j7pv25f6": true }, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "About", $$About, { "data-astro-cid-j7pv25f6": true })}` })} ${renderComponent($$result2, "SectionContainer", $$SectionContainer, { "id": "languages", "title": "My languages", "data-astro-cid-j7pv25f6": true }, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "Language", $$Languages, { "data-astro-cid-j7pv25f6": true })}` })} ${renderComponent($$result2, "SectionContainer", $$SectionContainer, { "id": "experience", "title": "My experience", ",": true, "icon": "/work.svg", "data-astro-cid-j7pv25f6": true }, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "Experience", $$Experience, { "data-astro-cid-j7pv25f6": true })}` })} ${renderComponent($$result2, "SectionContainer", $$SectionContainer, { "id": "skills", "title": "My skills", ",": true, "icon": "/person_check.svg", "data-astro-cid-j7pv25f6": true }, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "Skills", $$Skills, { "data-astro-cid-j7pv25f6": true })}` })} ${renderComponent($$result2, "SectionContainer", $$SectionContainer, { "id": "projects", "title": "My projects", "icon": "/construction.svg", "data-astro-cid-j7pv25f6": true }, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "Projects", $$Projects, { "data-astro-cid-j7pv25f6": true })}` })} ${renderComponent($$result2, "SectionContainer", $$SectionContainer, { "id": "", "title": "My education", ",": true, "icon": "/school.svg", "data-astro-cid-j7pv25f6": true }, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "Education", $$Education, { "data-astro-cid-j7pv25f6": true })}` })} </main> ` })} ${renderComponent($$result, "Footer", $$Footer, { "id": "contact-me", "data-astro-cid-j7pv25f6": true })}  `;
